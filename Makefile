...
# Gera os objetos
	gcc -c  comandos.c md5.c cliente.c servidor.c p2p.c
...
# Liga os objetos e gera o executavel utilizando as bibliotecas
	gcc -o executeme cliente.o servidor.o p2p.o comandos.a md5.a -lpthread

help:
	@echo  ..............................................................
	@echo   Para executar digite: ./executeme
	@echo
